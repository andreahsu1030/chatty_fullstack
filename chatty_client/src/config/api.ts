...
//用登入者id拿好友ids
export const API_FRIENDSHIPS_POST_SEARCH = 'http://localhost:3000/friendships/search'

//update 好友申請狀態
export const API_FRIENDSHIPS_PATCH_STATUS = 'http://localhost:3000/friendships/status'
...
// preview msg
export const API_MESSAGES_POST_PREVIEW = 'http://localhost:3000/messages/preview'
